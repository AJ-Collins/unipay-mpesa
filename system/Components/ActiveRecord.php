...
use helpers\behaviors\Delete;
use helpers\behaviors\Creator;
use helpers\audit\AuditBehavior;

class ActiveRecord extends \yii\db\ActiveRecord
{

	use \helpers\traits\Like;
	use \helpers\traits\Keygen;
	use \helpers\traits\Status;
	use \helpers\traits\ServiceConsumer;
	public function behaviors()
	{
		if ($this->tableName() == "{{%active_record}}" || $this->tableName() == "{{%base_model}}") {
	...
	{
		if ($this->hasAttribute('status') && $this->hasAttribute('is_deleted')) {
